...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        //Creating OPTIONALS for UOMs (Query methods and storing in optional-type classes)
        ...
        // Creating references for each UOMs found in DB:
        ...
        //Creating OPTIONALS for CATEGORIES (Query methods and storing in optional-type classes)
        ...
        // Creating references for each CATEGORY found in DB:
        Category americanCategory = americanCategoryOptional.get();
        Category mexicanCategory = mexicanCategoryOptional.get();

        //Populating data:
        //Yummy Guac recipe creation
        ...
        //Setting recipes and notes in each class (must be bi-directional relationship)
//        guacNotes.setRecipe(guacRecipe); //We can remove this after encapsulating the bi-directional setter in a helper method
        guacRecipe.setNotes(guacNotes);

        //Add ingredient to recipe. When instantiating ingredients, we've associate also its recipe (relationship in DB)
        //With a helper method 'addIngredient' we can populate data bi-directionally, avoiding too much code
        ...
        //add guacamole recipe to the return list
        recipes.add(guacRecipe);

        //Yummy Tacos recipe creation
        ...
        //Setting recipes and notes in each class (they have relationship)
//        tacoNotes.setRecipe(tacosRecipe); //We can remove this after encapsulating the bi-directional setter
        ...
        //add tacos recipe to the return list
